...
final class TransparAI_Compliance {
	 ...
	 * label names the use in tables, the text is the question itself.
	 *
	 * @return array<string, array{label:string, text:string, hint:string, articles:string[], action:string, page:string}>
	 */
