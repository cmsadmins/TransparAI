...
final class TransparAI_Compliance {
	...
	/**
	 * The six self-assessment questions, Article 50 uses first. Answers are
	 * yes or no; a "sometimes" adds nothing to which obligations apply. The
	 * label names the use in tables, the text is the question itself, the
	 * hint gives examples only, and the duty says what Regulation (EU)
	 * 2024/1689 asks of whom: Art. 50(1) and 50(2) address the provider,
	 * Art. 50(4) the deployer, and only for deepfakes (Art. 3(60)) and for
	 * unreviewed text on matters of public interest. Nothing in Article 50
	 * covers personalisation or translation as such.
	 *
	 * @return array<string, array{label:string, text:string, hint:string, duty:string, action:string, page:string}>
	 */
	public static function questions(): array {
		return array(
			...
			'synthetic_media' => array(
				'label'  => __( 'Synthetic audio, video and deepfakes', 'transparai' ),
				...
				'duty'   => __( 'Art. 50(2) obliges the provider of the generator to mark the output. Art. 50(4) obliges you as deployer to disclose deepfakes, which a cloned voice or an avatar of a real person is; a generic synthetic voice is not.', 'transparai' ),
	...
	/**
	 * Article 4 checklist items, in display order. Article 4 asks providers
	 * and deployers for measures, to their best extent, toward a sufficient
	 * level of AI literacy of staff and other persons operating or using AI
	 * systems on their behalf, considering their knowledge, experience,
	 * education and training, the context of use and the persons affected.
	 * It prescribes no training format or certificate; these items are the
	 * measures that usually serve as evidence, nothing more.
	 *
	...
	public static function literacy_items(): array {
		return array(
			...
			'context_considered' => __( 'For each AI tool, the context of use and the people it affects (visitors, customers) were considered when deciding what guidance staff need', 'transparai' ),
		);
	}
