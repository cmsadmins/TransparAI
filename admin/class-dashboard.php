...
final class TransparAI_Dashboard {
	...
	private static function render_literacy_card(): void {
		...
		<section class="trai-card" id="trai-literacy">
			...
			<p class="description"><?php esc_html_e( 'Article 4 applies since 2 February 2025 to every provider and deployer, whatever you answered above: the people who work with AI systems must have sufficient AI literacy. Tick what your organisation has done; the checklist counts toward the readiness score and appears in the compliance report with the name and date of the last save.', 'transparai' ); ?></p>
